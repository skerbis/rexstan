...
- **Hinweis auf niedrigeres Level bei sehr vielen Ergebnissen**: Liefert ein Lauf mehr als 200 Probleme, erscheint ein Hinweis, in den Einstellungen ein niedrigeres Level zu wählen und sich von dort schrittweise nach oben zu arbeiten. PHPStan-Level sind selbst bereits eine Priorisierung nach Strenge (jede Stufe baut auf den Prüfungen aller niedrigeren Stufen auf) – eine zusätzliche, parallele Kategorisierung der Ergebnisse (ursprünglich als Kritisch/Style/Wartbarkeit-Tabelle geplant und in einer früheren Version dieses PRs auch umgesetzt) würde dem nur ein zweites, konkurrierendes Ordnungsschema hinzufügen, statt den bereits vorhandenen Hebel (das Level) zu nutzen. Dank an @staabm für den Hinweis im Review.
